...
form.addEventListener("submit", function (event) {
  ...
  if (nom.value.length < 2) {
    document.getElementById("erreur-nom").textContent =
      "Le nom doit contenir au moins 2 caractéres.";
  ...
  if (prenom.value.length < 2) {
    document.getElementById("erreur-prenom").textContent =
      "Le prenom doit contenir au  moins 2 caractéres.";
  ...
  if (message.value.length < 19) {
    document.getElementById("erreur-message").textContent =
      "le message ne doit pas etre moins de 20 caractére";
  ...
  if (nom.value != "" && regex.test(email.value) && prenom.value != "" && message.value != "" && selection.value != "demande") {
...
let encoyerBtn = document.getElementById("envoyer");

encoyerBtn.addEventListener("click", function () {
  if (regex.test(emailInput.value)) {
    emailInput.textContent = "";
    emailInput.style.border = "1px solid green";
    emailInput.style.boxShadow = " 4px 4px 15px rgba(46, 218, 80, 0.4)";
  } else {
    erreurEmail.textContent = "email incorrect";
    erreurEmail.style.color = "red";
    emailInput.style.border = "1px solid red";
    emailInput.style.boxShadow = " 4px 4px 15px rgba(189, 83, 83, 0.4)";
  }
});